...
vlc_tls_ServerCreate (vlc_object_t *obj, const char *cert_path,
                      const char *key_path)
{
    vlc_tls_creds_t *srv = (vlc_tls_creds_t *)vlc_custom_create (obj, sizeof (*srv),
                                              "tls server");			// sunqueen modify
...
{
    vlc_tls_creds_t *crd = (vlc_tls_creds_t *)vlc_custom_create (obj, sizeof (*crd),
                                              "tls client");			// sunqueen modify
...
vlc_tls_t *vlc_tls_SessionCreate (vlc_tls_creds_t *crd, int fd,
                                  const char *host)
{
    vlc_tls_t *session = (vlc_tls_t *)vlc_custom_create (crd, sizeof (*session),
                                            "tls session");			// sunqueen modify
