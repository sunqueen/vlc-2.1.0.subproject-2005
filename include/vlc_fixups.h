...
extern "C" int inet_pton(int, const char *, void *);			// sunqueen modify
extern "C" const char *inet_ntop(int, const void *, char *, int);			// sunqueen modify
#endif
